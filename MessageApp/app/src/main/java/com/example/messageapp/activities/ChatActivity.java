    ...
    private final EventListener<QuerySnapshot> eventListener = (value, error) -> {
        ...
        if(value!= null){    //if there is changes in database
            ...
            for (DocumentChange documentChange : value.getDocumentChanges()){
                if(documentChange.getType() == DocumentChange.Type.ADDED){    //if new message is added( means received)
                    ...
                    messageInfo.message = documentChange.getDocument().getString(Constants.KEY_MESSAGE);
